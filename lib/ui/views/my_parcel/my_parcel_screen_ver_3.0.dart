...
//           WillPopScope(
//             onWillPop: () async {
//               return await showLogoutConfirmation(context);
//             },
//             child: SliverAppBar(
//               title: Center(
//                 child: Text(
...
//                       parcelDetails: parcelDetailsList.reversed.toList()[index],
//                     ),
//                   );
...
//     // If result is null (dialog is dismissed), default to false (cancel logout)
//     return result ?? false;
//   }
