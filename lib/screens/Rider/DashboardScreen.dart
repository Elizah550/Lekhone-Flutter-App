...
class _DashboardScreenState extends State<RiderDashboard>
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(
                          20), // Set border radius to match tab border radius
                    ),
                    child: TabBar(
                      controller: _tabController,
                      indicator: BoxDecoration(
                        borderRadius:
                            BorderRadius.circular(50), // Round the corners
                        color: Colors.black, // Change indicator color to black
                      ),
                      indicatorSize:
                          TabBarIndicatorSize.tab, // Use tab size for indicator
            ...
            child: TabBarView(
              ...
              children: [
                ...
                ListView(
                  ...
                  children: [
                    _buildDeliveryCard('Delivery Number', 'Order ID: #12345',
  ...
  Widget _buildDeliveryCard(String title, String orderId, String pickupLocation,
      String dropLocation) {
    return Card(
