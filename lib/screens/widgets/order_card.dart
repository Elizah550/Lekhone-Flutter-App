...
import 'package:Lekhone/models/order.dart';
import 'package:Lekhone/utils/helper.dart';
  ...
  switch (status) {
    case OrderStatus.PICKING_UP:
      return Container(
        ...
        child: Icon(
          EvaIcons
              .loaderOutline, // Use the loaderOutline icon from eva_icons_flutter
    ...
    case OrderStatus.DELIVERING:
      return Container(
        ...
        child: Icon(
          EvaIcons
              .clockOutline, // Use the clockOutline icon from eva_icons_flutter
